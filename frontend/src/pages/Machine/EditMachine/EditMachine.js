...
import styles from './EditMachine.module.scss'
...
const NewMachine = () => {
	...
	useEffect(() => {
		async function load() {
			...
			response.machine_model = response.machine_model.id
			response.engine_model = response.engine_model.id
			response.transmission_model = response.transmission_model.id
			response.driving_axle_model = response.driving_axle_model.id
			response.steering_axle_model = response.steering_axle_model.id
			response.client = response.client ? response.client.id : ''
	...
	return (
		<main className={styles.editMachine}>
			{clients && serviceCompany && machine && (
